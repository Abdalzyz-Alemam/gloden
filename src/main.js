...
const menuItems = [
  ...
  { id: 1, title: 'عصير قولدن', title_en: 'Golden Juice', price: '13,000', category: 'juices', image: 'https://images.unsplash.com/photo-1613478223719-2ab802602423?auto=format&fit=crop&q=80&w=400' },
  { id: 2, title: 'ليمون بالنعناع', title_en: 'Lemon Mint', price: '7,000', category: 'juices', image: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&q=80&w=400' },
  { id: 3, title: 'ليمون بالحليب', title_en: 'Lemon Milk', price: '9,000', category: 'juices', image: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&q=80&w=400' },
  { id: 4, title: 'عصير فراولة', title_en: 'Strawberry Juice', price: '9,000', category: 'juices', image: 'https://images.unsplash.com/photo-1546173155-212461643329?auto=format&fit=crop&q=80&w=400' },
  { id: 5, title: 'فراولة بالحليب', title_en: 'Strawberry Milk', price: '10,000', category: 'juices', image: 'https://images.unsplash.com/photo-1553177595-4de2bb0842b9?auto=format&fit=crop&q=80&w=400' },
  { id: 6, title: 'عصير منقة', title_en: 'Mango Juice', price: '9,000', category: 'juices', image: 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?auto=format&fit=crop&q=80&w=400' },
  { id: 7, title: 'منقة بالحليب', title_en: 'Mango Milk', price: '10,000', category: 'juices', image: 'https://images.unsplash.com/photo-1590740927233-a60d05770014?auto=format&fit=crop&q=80&w=400' },
  { id: 8, title: 'عصير برتقال', title_en: 'Orange Juice', price: '7,000', category: 'juices', image: 'https://images.unsplash.com/photo-1622597467822-26c78679374c?auto=format&fit=crop&q=80&w=400' },
  { id: 9, title: 'عصير أناناس', title_en: 'Pineapple Juice', price: '7,000', category: 'juices', image: 'https://images.unsplash.com/photo-1554522941-8e77a16db3c8?auto=format&fit=crop&q=80&w=400' },
  { id: 10, title: 'عصير قريب فروت', title_en: 'Grapefruit Juice', price: '7,000', category: 'juices', image: 'https://images.unsplash.com/photo-1582234372722-50d7ccc30ebd?auto=format&fit=crop&q=80&w=400' },
  { id: 11, title: 'كوكتيل مشكل', title_en: 'Mixed Cocktail', price: '11,000', category: 'juices', image: 'https://images.unsplash.com/photo-1613478223719-2ab802602423?auto=format&fit=crop&q=80&w=400' },
  { id: 12, title: 'موز بالحليب', title_en: 'Banana Milk', price: '9,000', category: 'juices', image: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&q=80&w=400' },

  // Milk Shakes (Image 1)
  { id: 13, title: 'قولدن شيك الفاخر', title_en: 'Golden Luxury Shake', price: '21,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&q=80&w=400' },
  { id: 14, title: 'فانيليا ملك شيك', title_en: 'Vanilla Milkshake', price: '12,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1626078436727-b92834945a0f?auto=format&fit=crop&q=80&w=400' },
  { id: 15, title: 'شوكولاته ملك شيك', title_en: 'Chocolate Milkshake', price: '14,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&q=80&w=400' },
  { id: 16, title: 'أوريو ملك شيك', title_en: 'Oreo Milkshake', price: '12,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1603569283847-aa295f0d016a?auto=format&fit=crop&q=80&w=400' },
  { id: 17, title: 'كت كات شيك', title_en: 'KitKat Shake', price: '15,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&q=80&w=400' },
  { id: 18, title: 'إسنيكرز شيك', title_en: 'Snickers Shake', price: '16,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&q=80&w=400' },
  { id: 19, title: 'باونتي شيك', title_en: 'Bounty Shake', price: '16,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&q=80&w=400' },
  { id: 20, title: 'تويكس شيك', title_en: 'Twix Shake', price: '16,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&q=80&w=400' },
  { id: 21, title: 'شوكولاتة دبي شيك', title_en: 'Dubai Chocolate Shake', price: '15,000', category: 'shakes', image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&q=80&w=400' },
  ...
  { id: 41.1, title: 'بيتزا هوت دوق (صغير)', title_en: 'Hot Dog Pizza (Small)', price: '18,000', category: 'food', image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?auto=format&fit=crop&q=80&w=400', description: 'قطع الهوت دوق اللذيذة مع الخضار المشكلة والصلصة المميزة', description_en: 'Delicious hot dog pieces with mixed vegetables and special sauce' },
  { id: 41.2, title: 'بيتزا هوت دوق (وسط)', title_en: 'Hot Dog Pizza (Medium)', price: '27,000', category: 'food', image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?auto=format&fit=crop&q=80&w=400', description: 'قطع الهوت دوق اللذيذة مع الخضار المشكلة والصلصة المميزة', description_en: 'Delicious hot dog pieces with mixed vegetables and special sauce' },
  { id: 41.3, title: 'بيتزا هوت دوق (كبير)', title_en: 'Hot Dog Pizza (Large)', price: '39,000', category: 'food', image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?auto=format&fit=crop&q=80&w=400', description: 'قطع الهوت دوق اللذيذة مع الخضار المشكلة والصلصة المميزة', description_en: 'Delicious hot dog pieces with mixed vegetables and special sauce' },

  { id: 42.1, title: 'بيتزا مفرومة (صغير)', title_en: 'Minced Meat Pizza (Small)', price: '19,000', category: 'food', image: 'https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&q=80&w=400', description: 'اللحم المفروم الطازج مع خلطة البهارات الخاصة والجبنة', description_en: 'Fresh minced meat with special spice mix and cheese' },
  { id: 42.2, title: 'بيتزا مفرومة (وسط)', title_en: 'Minced Meat Pizza (Medium)', price: '28,000', category: 'food', image: 'https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&q=80&w=400', description: 'اللحم المفروم الطازج مع خلطة البهارات الخاصة والجبنة', description_en: 'Fresh minced meat with special spice mix and cheese' },
  { id: 42.3, title: 'بيتزا مفرومة (كبير)', title_en: 'Minced Meat Pizza (Large)', price: '39,000', category: 'food', image: 'https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&q=80&w=400', description: 'اللحم المفروم الطازج مع خلطة البهارات الخاصة والجبنة', description_en: 'Fresh minced meat with special spice mix and cheese' },
  ...
  { id: 44.1, title: 'بيتزا ميكس لحوم (صغير)', title_en: 'Meat Mix Pizza (Small)', price: '19,000', category: 'food', image: 'https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?auto=format&fit=crop&q=80&w=400', description: 'بيتزا غنية بتشكيلة فاخرة من اللحوم المختلفة لمحبي الطعم القوي', description_en: 'Pizza rich with a premium selection of different meats for strong flavor lovers' },
  { id: 44.2, title: 'بيتزا ميكس لحوم (وسط)', title_en: 'Meat Mix Pizza (Medium)', price: '29,000', category: 'food', image: 'https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?auto=format&fit=crop&q=80&w=400', description: 'بيتزا غنية بتشكيلة فاخرة من اللحوم المختلفة لمحبي الطعم القوي', description_en: 'Pizza rich with a premium selection of different meats for strong flavor lovers' },
  { id: 44.3, title: 'بيتزا ميكس لحوم (كبير)', title_en: 'Meat Mix Pizza (Large)', price: '40,000', category: 'food', image: 'https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?auto=format&fit=crop&q=80&w=400', description: 'بيتزا غنية بتشكيلة فاخرة من اللحوم المختلفة لمحبي الطعم القوي', description_en: 'Pizza rich with a premium selection of different meats for strong flavor lovers' },

  { id: 45.1, title: 'بيتزا دجاج (صغير)', title_en: 'Chicken Pizza (Small)', price: '19,000', category: 'food', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&q=80&w=400', description: 'قطع الدجاج المتبلة مع صوص المايونيز والجبنة والخضار الطازجة', description_en: 'Marinated chicken pieces with mayo sauce, cheese, and fresh vegetables' },
  { id: 45.2, title: 'بيتزا دجاج (وسط)', title_en: 'Chicken Pizza (Medium)', price: '28,000', category: 'food', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&q=80&w=400', description: 'قطع الدجاج المتبلة مع صوص المايونيز والجبنة والخضار الطازجة', description_en: 'Marinated chicken pieces with mayo sauce, cheese, and fresh vegetables' },
  { id: 45.3, title: 'بيتزا دجاج (كبير)', title_en: 'Chicken Pizza (Large)', price: '39,000', category: 'food', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&q=80&w=400', description: 'قطع الدجاج المتبلة مع صوص المايونيز والجبنة والخضار الطازجة', description_en: 'Marinated chicken pieces with mayo sauce, cheese, and fresh vegetables' },

  // --- CALZONE (Category: calzone) ---
  { id: 46, title: 'كلزوني قولدن (Golden)', title_en: 'Golden Calzone', price: '15,000', category: 'calzone', image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?auto=format&fit=crop&q=80&w=400' },
  { id: 47, title: 'كلزوني هوت دوق (Hot dog)', title_en: 'Hot Dog Calzone', price: '15,000', category: 'calzone', image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?auto=format&fit=crop&q=80&w=400' },
  ...
  { id: 49.2, title: 'كلزوني خضار (Vegetable)', title_en: 'Vegetable Calzone', price: '13,000', category: 'calzone', image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?auto=format&fit=crop&q=80&w=400' },
  ...
  { id: 51.1, title: 'لافا فرايز (صغير)', title_en: 'Lava Fries (Small)', price: '11,000', category: 'fries', image: 'https://images.unsplash.com/photo-1585109649139-366815a0d713?auto=format&fit=crop&q=80&w=400', description: 'بطاطس غارقة بصوص اللافا الساخن والجبنة ومزيج من الإضافات المميزة', description_en: 'Fries drenched in hot lava sauce and cheese with a mix of special toppings' },
  { id: 51.2, title: 'لافا فرايز (كبير)', title_en: 'Lava Fries (Large)', price: '19,000', category: 'fries', image: 'https://images.unsplash.com/photo-1585109649139-366815a0d713?auto=format&fit=crop&q=80&w=400', description: 'بطاطس غارقة بصوص اللافا الساخن والجبنة ومزيج من الإضافات المميزة', description_en: 'Fries drenched in hot lava sauce and cheese with a mix of special toppings' },
  ...
  { id: 53, title: 'نوتيلا رول ميكس صوص', title_en: 'Nutella Roll Mix Sauce', price: '17,000', category: 'desserts', image: 'https://images.unsplash.com/photo-1621303837174-89787a7d4729?auto=format&fit=crop&q=80&w=400' },
